...
import { Users, Plus, Shield, Award } from 'lucide-react';
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '16px' }}>
        {teams.map((t, idx) => (
          <div key={t.id || idx} className="glass-panel" style={{ padding: '20px' }}>
            ...
            <div style={{ background: 'rgba(255, 255, 255, 0.03)', borderRadius: '10px', padding: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span className="text-muted" style={{ fontSize: '0.85rem' }}>W / L Record</span>
